...
- Creates or updates: `aidd/work/AUDIT.md`
...
11. **Collect External Signals (GitHub)**
    - Check if `aidd/work/github-signals.md` exists
...
- Update `aidd/memory/activeContext.md` if significant insights are discovered
