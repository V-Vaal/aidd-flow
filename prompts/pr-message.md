...
- `aidd/memory/activeContext.md` (current state and recent changes)
- Git changes (git diff, modified files)
- Implemented code changes

## Output Artefact

- Creates or updates: `aidd/work/PR.md`
...
- After PR is merged, update `aidd/memory/activeContext.md` with merge details
- Follow `rules/05-workflows-and-processes/5-open-source-pr.md` for PR format if present

## Definition of Done

- PR.md exists at `aidd/work/PR.md`
