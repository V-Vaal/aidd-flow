...
- Creates or updates: `.cursor/work/DEBUG.md`
...
6. **Plan verification steps**
   ...
   - Include: `bash .cursor/scripts/aidd-check.sh`
   - Include: `bash .cursor/scripts/aidd-verify-ui.sh` (if UI-related)
...
- Run `bash .cursor/scripts/validate-plan.sh` if PLAN.md was created/updated
- After successful fix, update `.cursor/memory/activeContext.md`
...
- DEBUG.md exists at `.cursor/work/DEBUG.md`
...
- `.cursor/memory/activeContext.md` is updated
