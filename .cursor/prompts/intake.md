...
- `.cursor/memory/techContext.md` for technical stack information

## Output Artefact

- Creates or updates: `.cursor/work/INTAKE.md`
...
- INTAKE.md exists at `.cursor/work/INTAKE.md`
